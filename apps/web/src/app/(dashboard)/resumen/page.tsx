  ...
  return (
    <>
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        {/* Hero Section */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Bienvenido, Corredor!</h1>
          <p className="text-gray-600">Resumen de tu actividad de fe pública</p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm">
            ...
            <div className="mb-6">
              <p className="text-4xl font-bold text-gray-900">{stats.documentosGenerados}</p>
        ...
        <div className="grid grid-cols-3 gap-6 mt-6">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm">
            ...
            <p className="text-4xl font-bold text-gray-900 mb-4">{stats.clientesActivos}</p>
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-1 text-green-500">
                <TrendingUp size={16} />
                <span className="text-sm font-semibold">+8.2%</span>
              </div>
              <span className="text-gray-500 text-sm">vs mes pasado</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div>
                <p className="text-sm text-gray-600 mb-2">Tasa de Aprobación</p>
