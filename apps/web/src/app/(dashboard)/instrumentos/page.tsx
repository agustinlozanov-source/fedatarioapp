  ...
  return (
    <>
      ...
      <div className="p-6">
        ...
        {/* Buscador Fuzzy */}
        <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white border border-black/[0.08] mb-4 shadow-sm">
        ...
        {cargando ? (
          ...
          <div className="bg-white border border-black/[0.07] rounded-2xl overflow-hidden shadow-sm">
            {filtrados.map((inst, i) => {
              ...
              return (
                <div key={inst.id} className={i > 0 ? 'border-t border-black/[0.04]' : ''}>
                  {/* Fila principal */}
                  <div
                    className="flex items-center gap-4 px-5 py-3.5 hover:bg-[#F5F5F7] transition-colors cursor-pointer group"
                  ...
                  {expanded && (
                    <div className="px-5 pb-4 border-t border-black/[0.04]" style={{ background: 'var(--bg2)' }}>
                      <div className="pt-4 grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="bg-white rounded-xl px-4 py-3 space-y-1.5">
                            {[
                              ...
                              <div key={f.label} className="flex gap-2 items-baseline">
                                ...
                                <span className="text-[12px] font-semibold text-[#1D1D1F] truncate">{f.val}</span>
                              </div>
                            ))}
                          </div>
